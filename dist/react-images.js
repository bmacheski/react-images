  ...
  createClass(Tags, [{
    ...
    value: function render$$1() {
      ...
      return React__default.createElement(
        "div",
        {
          className: noImportant.css(editingTags ? classes$1.editingTags : classes$1.paginatedThumbnails)
        },
        editingTags && React__default.createElement(
          ...
          React__default.createElement(
            ...
            React__default.createElement(
              ...
              "Dismiss ",
              React__default.createElement("i", { className: "fas fa-times" })
            )
          ),
          tags.map(function (x) {
...
var Lightbox = function (_Component) {
  ...
  createClass(Lightbox, [{
      ...
      return React__default.createElement(
        ...
        currentImageTags.map(function (x) {
          return React__default.createElement(
            React__default.Fragment,
            null,
            React__default.createElement(Tag, { value: x }),
    ...
    value: function renderTags() {
      ...
      return React__default.createElement(Tags, {
        toggleEditTags: toggleEditTags,
